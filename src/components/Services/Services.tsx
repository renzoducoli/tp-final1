            ...
            <div className="flex flex-col md:flex-row gap-x-5">
                <div className="flex flex-col text-center md:text-left md:w-[30vw] mb-10">
                    ...
                    <motion.p
                        ...
                        animate="show"
                        exit="hidden"
                        className="max-w-md">Potenciamos tu presencia en línea con diseño, redacción persuasiva y optimización SEO experta para alcanzar tus objetivos empresariales.
                    </motion.p>
                </div>
